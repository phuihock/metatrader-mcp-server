...
def main():
    ...
    open_positions = client.order.get_all_positions()
    print(tabulate(open_positions, headers="keys", tablefmt="psql"))

    # Get list of pending orders
    print("\n\n🦢 LIST ALL PENDING ORDERS \n")
    pending_orders = client.order.get_all_pending_orders()
    ...
    new_market_order_1 = client.order.place_market_order(
        type="BUY",
        symbol="EURUSD",
        volume=0.1,
    )
    ...
    new_market_order_2 = client.order.place_market_order(
        type="SELL",
        symbol="USDJPY",
        volume=0.1,
    )
    ...
    new_pending_order_1 = client.order.place_pending_order(
        type="SELL",
        symbol="GBPUSD",
        volume=0.1,
        price=1.32400,
    ...
    new_pending_order_2 = client.order.place_pending_order(
        type="BUY",
        symbol="GBPUSD",
        volume=0.1,
        price=1.32100,
